...
const CalendarDay = ({
  ...
  return (
    <div
      key={index}
      className={cn(
        'flex h-[70px] cursor-pointer flex-col items-center justify-between rounded-sm border border-black/5 bg-bgSoft p-4 text-sm font-medium transition-all active:bg-bgSofter lg:h-full lg:flex-row lg:justify-center lg:gap-4 lg:hover:bg-bgSofter',
        {
